...
name="closed_25kW_500slpm_20_"
# DATA_FILE="C:\\Users\\qpw475\\Documents\\combustion_instability\\data\\raw\\transient\\hidrogen\\open_25kW_600slpm_70%to80%.csv"
DATA_FILE="C:\\Users\\qpw475\\Documents\\combustion_instability\\data\\raw\\h2\\"+name+".csv"
...
# axs[0].axvline(x=19.3, color='red', linestyle='--', linewidth=1, label='19.3 seconds')
axs[0].set_title(f'Pressure {name}')
...
# axs[1].axvline(x=19.3, color='red', linestyle='--', linewidth=1, label='19.3 seconds')
...
pressure_list= notch_filter(pressure_list, 10000, 60.0, 10.0)
heat_list= notch_filter(heat_list, 10000, 60.0, 10.0)
...
axs[0].set_title(f'FFT of Pressure  {name}')
...
filtered_df_0_to_18 = df[(df['time'] >= 0) & (df['time'] <= 18)]

# Calculate the standard deviation for pressure and heat
std_pressure = filtered_df_0_to_18['pressure'].std()
std_heat = filtered_df_0_to_18['heat'].std()

# Calculate the peak-to-peak values for pressure and heat
ptp_pressure = filtered_df_0_to_18['pressure'].max() - filtered_df_0_to_18['pressure'].min()
ptp_heat = filtered_df_0_to_18['heat'].max() - filtered_df_0_to_18['heat'].min()

# Print the results
print(f"Standard Deviation of Pressure (0 to 18 seconds): {std_pressure}")
print(f"Standard Deviation of Heat (0 to 18 seconds): {std_heat}")
print(f"Peak-to-Peak of Pressure (0 to 18 seconds): {ptp_pressure}")
print(f"Peak-to-Peak of Heat (0 to 18 seconds): {ptp_heat}")

# Filter the DataFrame for the time range from 18 to 19.3 seconds
filtered_df_18_to_19_3 = df[(df['time'] >= 18) & (df['time'] <= 19.3)]
...
# Print the results
print(f"Standard Deviation of Pressure (18 to 19.3 seconds): {std_pressure_18_to_19_3}")
print(f"Standard Deviation of Heat (18 to 19.3 seconds): {std_heat_18_to_19_3}")
print(f"Peak-to-Peak of Pressure (18 to 19.3 seconds): {ptp_pressure_18_to_19_3}")
print(f"Peak-to-Peak of Heat (18 to 19.3 seconds): {ptp_heat_18_to_19_3}")

# Filter the DataFrame for the time range from 19.3 to 20 seconds
filtered_df_19_3_to_20 = df[(df['time'] > 19.3) & (df['time'] <= 20)]
...
# Print the results
print(f"Standard Deviation of Pressure (19.3 to 20 seconds): {std_pressure_19_3_to_20}")
print(f"Standard Deviation of Heat (19.3 to 20 seconds): {std_heat_19_3_to_20}")
print(f"Peak-to-Peak of Pressure (19.3 to 20 seconds): {ptp_pressure_19_3_to_20}")
print(f"Peak-to-Peak of Heat (19.3 to 20 seconds): {ptp_heat_19_3_to_20}")

# Filter the DataFrame for the time range from 17 to 18 seconds
filtered_df_17_to_18 = df[(df['time'] >= 17) & (df['time'] <= 18)]
...
# Print the results
print(f"Standard Deviation of Pressure (17 to 18 seconds): {std_pressure_17_to_18}")
print(f"Standard Deviation of Heat (17 to 18 seconds): {std_heat_17_to_18}")
print(f"Peak-to-Peak of Pressure (17 to 18 seconds): {ptp_pressure_17_to_18}")
print(f"Peak-to-Peak of Heat (17 to 18 seconds): {ptp_heat_17_to_18}")

# Filter the DataFrame for the time range from 20 to 21 seconds
filtered_df_20_to_21 = df[(df['time'] >= 20) & (df['time'] <= 21)]
...
# Print the results
print(f"Standard Deviation of Pressure (20 to 21 seconds): {std_pressure_20_to_21}")
print(f"Standard Deviation of Heat (20 to 21 seconds): {std_heat_20_to_21}")
print(f"Peak-to-Peak of Pressure (20 to 21 seconds): {ptp_pressure_20_to_21}")
print(f"Peak-to-Peak of Heat (20 to 21 seconds): {ptp_heat_20_to_21}")



# Filter the DataFrame for the time range from 20 to 24 seconds
filtered_df_20_to_24 = df[(df['time'] >= 20) & (df['time'] <= 24)]
...
# Print the results
print(f"Standard Deviation of Pressure (20 to 24 seconds): {std_pressure_20_to_24}")
print(f"Standard Deviation of Heat (20 to 24 seconds): {std_heat_20_to_24}")
print(f"Peak-to-Peak of Pressure (20 to 24 seconds): {ptp_pressure_20_to_24}")
print(f"Peak-to-Peak of Heat (20 to 24 seconds): {ptp_heat_20_to_24}")
...
filtered_df = df[(df['time'] >= 18) & (df['time'] <= 20)]
...
axs[0].axvline(x=19.3, color='red', linestyle='--', linewidth=1, label='19.3 seconds')
axs[0].set_title('Pressure (18 to 20 seconds)')
axs[0].set_xlabel('Time (s)')
axs[0].set_ylabel('Pressure')
axs[0].legend()
...
axs[1].axvline(x=19.3, color='red', linestyle='--', linewidth=1, label='19.3 seconds')
axs[1].set_title('Heat (18 to 20 seconds)')
axs[1].set_xlabel('Time (s)')
axs[1].set_ylabel('Heat')
axs[1].legend()
...
# Plot FFT of pressure
axs[0].plot(filtered_freqs, filtered_pressure_fft, label='Pressure FFT')
axs[0].set_title('FFT of Pressure (18 to 20 seconds, up to 500 Hz)')
axs[0].set_xlabel('Frequency (Hz)')
axs[0].set_ylabel('Magnitude')
axs[0].legend()
...
# Plot FFT of heat
axs[1].plot(filtered_freqs, filtered_heat_fft, label='Heat FFT', color='orange')
axs[1].set_title('FFT of Heat (18 to 20 seconds, up to 500 Hz)')
axs[1].set_xlabel('Frequency (Hz)')
axs[1].set_ylabel('Magnitude')
axs[1].legend()
...
selected_frequencies = [40,110,120,150]  # Frequencies to plot
line_data = {}
...
for i in range(1):
    ...
    start_time = (i * segment_duration)+18
