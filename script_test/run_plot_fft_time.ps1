...
if (-not $fft_path) {
    ...
    # $fft_path = "C:\Users\qpw475\Documents\combustion_instability\data\fft\${fuel}\window_500ms\data.pkl"
}
...
$python_script = "C:\Users\qpw475\Documents\combustion_instability\src_test\plot_fft_time.py" #  borrar
